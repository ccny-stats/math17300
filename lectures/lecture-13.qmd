...
[Source](https://shiny.stat.lsa.umich.edu/pvals/)

```{=html}
<iframe width = "780" height = "800" src="https://shiny.stat.lsa.umich.edu/pvals/" title = "Interactive normal distributions"><\iframe>
```
...
x is a normally distributed normal random variable with a mean of 10 and standard deviation of 2. Fine the probability that x lies between 11 and 13.6?
...
Gase mileage for compact cars is normally distributed with mean of 35.5 mpg and std of 4.5.
