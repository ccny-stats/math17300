...
Suppose that an experiment involces a large number *N* of simple events and you know that all the simple events are equally likely - each simple event has probability $\frac{1}{N}$.
...
$$
n_1n_2n_3\dots n_k = \prod_{i=1}^k n_k
$$
