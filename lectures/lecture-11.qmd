...
Toss two fair cons and let x equal the number of heads observed. Find the probability distribution for x.

-   table with x, number of heads, simple events and p(x)

-   draw histogram with this information

### The Mean and Standard Deviatiobn for a Discrete Random Variable
